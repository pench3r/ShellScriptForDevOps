...
"""
Created by PyCharm.
File Name:              LinuxBashShellScriptForOps:WXBizMsgCrypt.py.py
Version:                0.0.1
Author:                 dgden
...
if __name__ == "__main__":
    ...
    return_code, encrypt_xml = encryp_test.EncryptMsg(to_xml, nonce)
    print return_code, encrypt_xml
    ...
    return_code, decryp_xml = decrypt_test.DecryptMsg(from_xml, msg_sign, timestamp, nonce)
    print return_code, decryp_xml
