...
Create Time:        15:02
References:         [argparse](https://docs.python.org/zh-cn/2/library/argparse.html)
 """
import argparse
...
# [metavar](https://docs.python.org/zh-cn/2/library/argparse.html#metavar)
parser.add_argument('--t4-s1', nargs='*', metavar='para', help='desc')  # argument will be saved to t4_s1

# [dest](https://docs.python.org/zh-cn/2/library/argparse.html#dest)
parser.add_argument('--t5-s2', dest='para1', nargs='*', metavar='para')  # argument will be saved to para1

# [type](https://docs.python.org/zh-cn/2/library/argparse.html#type)
